...
# Main function
def main(inputNPZ, label_csv, model_base_path, output_csv, chunk_size=25000, batch_size=32, args=None):
    # Load data
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_tracked_batch', type=int, default=8, help='total number of batch tracked by CTT')
