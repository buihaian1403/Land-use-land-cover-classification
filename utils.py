...
def net_builder(net_name, net_conf=None, num_classes=12):
    """
    ...
    elif net_name in ['resnet18','resnet50','resnet101']:
        import models.nets.resnet as net
        builder = getattr(net, 'build_ResNet50')()
        setattr_cls_from_kwargs(builder, {'net_name':net_name})
    else:
