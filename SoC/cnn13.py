...
class CNN13(nn.Module):
    def __init__(self, num_classes=12, dropout=0.5):
        ...
        self.conv1a = weight_norm(nn.Conv2d(10, 128, 3, padding=1))
        ...
        self.conv3a = weight_norm(nn.Conv2d(256, 512, 3, padding=1))
        ...
        # Adaptive pooling ensures a fixed output size
    ...
    def forward(self, x, ood_test=False):
        ...
        feature = out.squeeze(-1).squeeze(-1)
